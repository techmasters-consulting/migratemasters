    ...
    <section id="blog-listing-page" class="page-hero-section division">
        <div class="container">
            ...
            @php
             ...
             foreach($tags as $tag){
             $emptyArray = $tag->name;
             $singletag = json_decode($emptyArray);
            }
            @endphp
                ...
                <div class="col-md-7">
                    <div class="hero-txt white-color">
                        <h2 class="h2-xs">Article Collection of {{$singletag->en}} tag</h2>
                    </div>
                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb white-color">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tag for {{$singletag->en}} </li>
                        </ol>
                    </nav>
                </div>
            </div>  <!-- End row -->
...
@foreach ($articlesTag as $articleTag)
                        ...
                        <div class="blog-post">
                            ...
                            <div class="blog-post-txt icon-xs">
                                ...
                                <p class="post-meta">August 10, 2019 in
                                        ...
                                        <a href="/threads/">  <span>PR & Immigration</span></a>

                                </p>
                                <!-- Title -->
                                <h4 class="h4-xs deepblue-color">{{$articleTag->title ?? ''}}</h4>

                                <!-- Text -->
                                <p >{{$articleTag->excerpt ?? ''}}
                                </p>

                                <!-- Link -->
                                <a href="/threads/{{$articleTag->slug ?? ''}}" class="darkblue-color">Read More</a>
